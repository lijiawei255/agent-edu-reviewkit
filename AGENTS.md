...
本项目（agent-edu-reviewkit）是一个跨平台 AI 技能，将课程原始课件（PDF/PPTX/DOCX）转化为图文并茂的高质量 HTML 考试复习文档。输出为单个自包含 HTML 文件，包含 MathJax 数学排版、内联 SVG 示意图、课件原图、完整公式推导、例题详解、交互式学习组件、答题模板和常见错误附录。
